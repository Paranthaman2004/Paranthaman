...
const Cart = ({ show }) => {
  const { cartItems, totalPrice, OnInc, OnDec, RemoveOnCart, setTotalPrice } =
    useStates();
  return (
        ...
        <div className="cart_container">
          ...
          {cartItems.length === 0 ? (
            <div className="cart_empty">
              ...
              <Link to="/product"><button onClick={() =>{show(false)}}className="cart_btn">
                Continue Shoping
              </button></Link>
            </div>
          ) : (
            <div className="cart_items">
              ...
              <div className="check_out">
                ...
                <Link to="/payment"><button onClick={() => show(false)}>
                  Check out
                </button></Link>
              </div>
            </div>
